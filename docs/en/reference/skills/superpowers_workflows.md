...
|-------|------------|------|--------------|
| **Design Brainstorming Workflow** | 🟢 Basic | 30m | 80% |
| **Dispatching Parallel Agents** | 🟠 Advanced | N/A | 80% |
| **Full Feature Lifecycle** | 🔴 Expert | 1-2 weeks | 80% |
| **Implementation Planning Workflow** | 🟡 Intermediate | 1h | 80% |
| **Subagent-Driven Development** | 🟠 Advanced | N/A | 80% |
| **Systematic Debugging Workflow** | 🟡 Intermediate | N/A | 80% |
| **TDD Workflow** | 🟡 Intermediate | N/A | 80% |
