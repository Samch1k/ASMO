# Contributing to AI1st

Thank you for your interest in contributing to AI1st! This document provides guidelines and instructions for contributing.
...
1. Check [existing issues](https://github.com/Samch1k/ai1st-orchestration/issues) for similar reports
2. For features, open a [discussion](https://github.com/Samch1k/ai1st-orchestration/discussions) first
...
- Open an [issue](https://github.com/Samch1k/ai1st-orchestration/issues) for bugs
- Start a [discussion](https://github.com/Samch1k/ai1st-orchestration/discussions) for questions
- Read the [documentation](./docs/en/getting-started/index.md)

Thank you for contributing to AI1st! 🎉
